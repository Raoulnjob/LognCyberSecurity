 <#
.SYNOPSIS
    This PowerShell script ensures that the maximum size of the Windows security event log is at least 1024000 KB or greater.

.NOTES
    Author          : RAOUL NJOBI
    LinkedIn        : linkedin.com/in/raoul-njobi-6a97333ab/
    GitHub          : github.com/Raoulnjob
    Date Created    : 03/13/2026
    Last Modified   : 03/132026
    Version         : 1.0
    CVEs            : N/A
    Plugin IDs      : N/A
